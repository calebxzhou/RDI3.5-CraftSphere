...
public class GlyphManager {
    ...
    public void dumpInfo(SystemReport pw) {
        int glyphSize = 0;
        long memorySize = 0;
        for (var atlas : mAtlases.values()) {
        ...
        pw.setDetail("GlyphManager","");
        pw.setDetail("Atlases=" , mAtlases.size()+"");
        pw.setDetail("Glyphs=" , glyphSize+"");
        pw.setDetail("MemorySize=" , TextUtils.binaryCompact(memorySize) + " (" + memorySize + " bytes)");
    }
