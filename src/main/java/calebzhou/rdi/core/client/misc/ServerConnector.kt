...
object ServerConnector {
    ...
    val SERVER_INFO = ServerData(
        RdiSharedConstants.MODID_DISPLAY + RdiSharedConstants.CORE_VERSION_DISPLAY,
    ...
    @JvmStatic
	fun connect() {
        Minecraft.getInstance().window.setTitle(RdiSharedConstants.MODID_DISPLAY + " " + RdiSharedConstants.CORE_VERSION_DISPLAY)
