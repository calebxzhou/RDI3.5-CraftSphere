...
public class KeyBinds  {
   ...
   // public static KeyBinding AREA_SELECTION_KEY;
    public static void init(){
        HOME_KEY = KeyBindingHelper.registerKeyBinding(new KeyMapping("回到空岛", InputConstants.Type.KEYSYM,GLFW.GLFW_KEY_H, MODID_CHN));
        SLOWFALL_KEY = KeyBindingHelper.registerKeyBinding(new KeyMapping("缓降", InputConstants.Type.KEYSYM,GLFW.GLFW_KEY_J, MODID_CHN));
        LEAP_KEY = KeyBindingHelper.registerKeyBinding(new KeyMapping("隔空跳跃", InputConstants.Type.KEYSYM,GLFW.GLFW_KEY_G, MODID_CHN));
