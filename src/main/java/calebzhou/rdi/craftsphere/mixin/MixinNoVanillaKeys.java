...
public class MixinNoVanillaKeys {
    ...
    private void axca(Minecraft minecraft, File file, CallbackInfo ci){
        keyHotbarSlots=new KeyMapping[]{new KeyMapping("",0,"")};
        keySaveHotbarActivator=new KeyMapping("",0,"");
        keyLoadHotbarActivator=new KeyMapping("",0,"");
    }
...
class NoVanillaKey2{
    @ModifyConstant(method = "Lnet/minecraft/client/Minecraft;handleKeybinds()V",constant =
    @Constant(intValue = 9))
