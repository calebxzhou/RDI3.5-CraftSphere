...
import static com.spinyowl.legui.component.optional.align.VerticalAlign.*;
import static com.spinyowl.legui.event.MouseClickEvent.MouseClickAction.*;
        ...
        .addListener(MouseClickEvent.class, (MouseClickEventListener) event -> {
          ...
          if (CLICK == action) {
            mouseTargetLabel.getStyle().setDisplay(
                mouseTargetLabel.isVisible() ? DisplayType.NONE : DisplayType.MANUAL);
          }
          if (RELEASE == action) {
...
//                widget3.setResizable(!widget3.isResizable());
  ...
  private Widget createImageWrapperWidgetWithImage() {
    ...
    imageView = new ImageView(ImageLoader.loadImage("assets/rdict3/splash.png"));
